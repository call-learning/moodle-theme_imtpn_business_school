 ...
 */
function theme_imtpn_business_school_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
 ...
 * @param $page
 */
function theme_imtpn_business_school_page_init($page) {
